...
const mnemonic = "lumber limb begin motor garment manage clever kitten spike depth park wide";
...
module.exports = {
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider(mnemonic, "https://rinkeby.infura.io/v3/30032643c0aa445e9d567456d1ab3549"),
      network_id: 4,
